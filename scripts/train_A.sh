...
# checkpoint as INIT_FROM_CHECKPOINT for train_downstream.sh to finetune on downstream tasks.
# Optionally warm-start from train_identity.sh first. See docs/architecture/training_strategy.md.
